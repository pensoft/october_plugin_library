...
class Library extends Model
{
    ...
    public $belongsTo = [
        'library_type' => [LibraryType::class, 'key' => 'type'],
        'library_status' => [LibraryStatus::class, 'key' => 'status'],
    ];
    ...
    {
        if ($this->library_type) {
            return $this->library_type->name;
        }
        ...
        $types = [
            ...
            self::TYPE_PLEDGES => 'Pledges',
            self::TYPE_MILESTONE => 'Milestone',
            self::TYPE_FEATURE => 'Feature',
            self::TYPE_TECHNICAL_BRIEF => 'Technical brief',
        ];
    ...
    {
        if ($this->library_status) {
            return $this->library_status->name;
        }
        ...
        return $statuses[(int) $this->status] ?? 'Unknown';
    }

    public function getStatusOptions()
    {
        return LibraryStatus::orderBy('sort_order')->pluck('name', 'id')->toArray();
    }
    ...
    {
        return LibraryType::orderBy('sort_order')->pluck('name', 'id')->toArray();
    }
